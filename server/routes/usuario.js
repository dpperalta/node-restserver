...
//Invocar al middleware
const { verificaToken, verifcaAdmin_Role } = require('../middleware/autenticacion');
...
app.post('/usuario', [verificaToken, verifcaAdmin_Role], function(req, res) {
    ...
    usuario.save((err, usuarioDB) => {
        ...
        //usuarioDB.password = null; //Permite enviar un valor nulo en lugar de la contraseña en la respuesta del POST
        res.json({
            ok: true,
            usuario: usuarioDB
        });
...
app.delete('/usuario/:id', [verificaToken, verifcaAdmin_Role], function(req, res) {
    ...
    // Eliminar físicamente un usuario de la BD
